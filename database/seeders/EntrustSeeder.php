...
class EntrustSeeder extends Seeder
{
    public function run(){
        ...
        // CUSTOMER ADDRESS
        $manageCustomersAddresses = Permission::create(['name' => 'manage_customer_address', 'display_name' => 'CustomersAddresses', 'route' => 'customer_address', 'module' => 'customer_address', 'as' => 'customer_address.index', 'icon' => 'fas fa-map-marked-alt', 'parent' => '0', 'parent_original' => '0', 'sidebar_link' => '1', 'appear' => '1', 'ordering' => '40']);
        $manageCustomersAddresses->parent_show = $manageCustomersAddresses->id ;$manageCustomersAddresses->save();
        // SHOW CUSTOMER ADDRESS
        $showCustomersAddresses = Permission::create(['name' => 'show_customer_address', 'display_name' => 'CustomersAddresses', 'route' => 'customer_address', 'module' => 'customer_address', 'as' => 'customer_address.index', 'icon' => 'fas fa-map-marked-alt', 'parent' => $manageCustomersAddresses->id, 'parent_original' => $manageCustomersAddresses->id, 'parent_show' => $manageCustomersAddresses->id, 'sidebar_link' => '1', 'appear' => '1']);
        // CREATE CUSTOMER ADDRESS 
        $createCustomersAddresses = Permission::create(['name' => 'create_customer_address', 'display_name' => 'Create CustomersAddresses', 'route' => 'customer_address', 'module' => 'customer_address', 'as' => 'customer_address.create', 'icon' => 'fas fa-map-marked-alt', 'parent' => $manageCustomersAddresses->id, 'parent_original' => $manageCustomersAddresses->id, 'parent_show' => $manageCustomersAddresses->id, 'sidebar_link' => '1', 'appear' => '0']);
        // DISPLAY CUSTOMER ADDRESS
        $displayCustomersAddresses = Permission::create(['name' => 'display_customer_address', 'display_name' => 'Show CustomersAddresses', 'route' => 'customer_address', 'module' => 'customer_address', 'as' => 'customer_address.show', 'icon' => null, 'parent' => $manageCustomersAddresses->id, 'parent_original' => $manageCustomersAddresses->id, 'parent_show' => $manageCustomersAddresses->id, 'sidebar_link' => '1', 'appear' => '0']);
        // UPDATE CUSTOMER ADDRESS
        $updateCustomersAddresses = Permission::create(['name' => 'update_customer_address', 'display_name' => 'Update CustomersAddresses', 'route' => 'customer_address', 'module' => 'customer_address', 'as' => 'customer_address.edit', 'icon' => null, 'parent' => $manageCustomersAddresses->id, 'parent_original' => $manageCustomersAddresses->id, 'parent_show' => $manageCustomersAddresses->id, 'sidebar_link' => '1', 'appear' => '0']);
        // DELETE CUSTOMER ADDRESS
        $deleteCustomersAddresses = Permission::create(['name' => 'delete_customer_address', 'display_name' => 'Delete CustomersAddresses', 'route' => 'customer_address', 'module' => 'customer_address', 'as' => 'customer_address.destroy', 'icon' => null, 'parent' => $manageCustomersAddresses->id, 'parent_original' => $manageCustomersAddresses->id, 'parent_show' => $manageCustomersAddresses->id, 'sidebar_link' => '1', 'appear' => '0']);
