...
<header class="header bg-white">
    <div class="container px-lg-3">
        <nav class="navbar navbar-expand-lg navbar-light py-3 px-lg-0"><a class="navbar-brand" href="{{ route('front.index') }}"><span class="fw-bold text-uppercase text-dark">{{ config('app.name') }}</span></a>
                    ...
                    @else
                        <li class="nav-item">
                            ...
                            <div class="dropdown-menu mt-3" aria-labelledby="authDropdown">
                                 My profile, a href=javascript:void(0); class=dropdown-item.border-0 Logout
                                <a class="dropdown-item border-0">My profile</a>
