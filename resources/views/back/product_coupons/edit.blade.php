...
@section('content')
    <div class="card shadow mb-4">
        <div class="card-header py-3 d-flex">
            <h6 class="m-0 font-weight-bold text-primary">Edit category {{ $productCoupon->code }}</h6>
            <div class="ml-auto">
        ...
        <div class="container">
            <form action="{{ route('admin.product_coupons.update' , $productCoupon->id ) }}" method="post">
                ...
                <div class="row">
                    ...
                    <div class="col-3">
                        <div class="form-group">
                            ...
                            <input type="text" name="use_times" value="{{ old('use_times' , $productCoupon->use_times) }}" class="form-control">
                ...
                <div class="row">
                    <div class="col-3">
                        <div class="form-group">
                            ...
                            <input type="text" id="start_date" name="start_date" value="{{ old('start_date' , $productCoupon->start_date->format('Y-m-d')) }}" class="form-control">
                    ...
                    <div class="col-3">
                        <div class="form-group">
                            ...
                            <input type="text" id="expire_date" name="expire_date" value="{{ old('expire_date' , $productCoupon->expire_date->format('Y-m-d')) }}" class="form-control">
                ...
                <div class="form-group pt-4">
                    <button type="submit" name="submit" class="btn btn-primary">Update Coupons</button>
                </div>
            </form>
        </div>
    </div>
