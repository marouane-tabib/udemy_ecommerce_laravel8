                    ...
                    <div class="col-3">
                        ...
                        <select name="product_category_id" class="form-control">
                            ...
                            @forelse($categories as $category)
                                <option value="{{ $category->id }}" {{ old('parent_id' , $product->product_category_id) == $category->id ? 'selected' : null }}>{{ $category->name }}</option>
                            @empty
                    ...
                    <div class="row">
                        ...
                        <div class="col-3">
                            ...
                            <select name="featured" class="form-control">
                                <option value="1" {{ old('featured' , $product->featured) == 1 ? 'selected' : null }}>Active</option>
                                <option value="0" {{ old('featured' , $product->featured) == 0 ? 'selected' : null }}>Inactive</option>
                            </select>
                ...
                <div class="row pt-4">
                    <div class="col-12">
                        ...
                        <div class="file-loading">
                            <input type="file" name="images[]" id="products-images" class="file-input-overview" multiple="multiple">
        ...
        $(function(){
            ...
            $('.summernote').summernote({
                ...
                toolbar: [
                    ...
                    ['table' , ['table']],
                    ['insert' , ['link' , 'picture' , 'videp']],
                    ['view' , ['fullscreen' , 'codeview' , 'help']]
                ]
            })

            // Category Image
            $("#products-images").fileinput({
                theme: "fas",
                maxFileCount: 5,
